<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"Q:\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\links\edit.htm";i:1475054465;s:79:"Q:\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\common\top.htm";i:1523632913;s:80:"Q:\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\common\left.htm";i:1475999534;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="title" placeholder="" name="title" value="<?php echo $Links['title']; ?>" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="desc" class="form-control"><?php echo $Links['desc']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">

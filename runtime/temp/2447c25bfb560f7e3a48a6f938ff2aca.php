<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"Q:\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\login\login.htm";i:1523779840;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="login-container animated fadeInDown">
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="logobox">
                    <p class="text-center">欢迎登陆庹明志博客后台 账号：admin 密码：123456 </p>
                </div>
        </form>
    </div>
    <!--Basic Scripts-->
